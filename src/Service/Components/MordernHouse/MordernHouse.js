    ...
    <>
      <div>
        ...
        <div className="text-overlay">
          <h1 className="future-h1">THE FUTURE OF <br /><span className="mordern">MODERN HOUSE</span></h1>
          <p className="easy-para">EASY WAY TO PERFECT PROPERTY , WE ARE YOUR TRUSTED PARTNER .</p>
         <div id="button-div">
